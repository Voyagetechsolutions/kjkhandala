...
// Platform Admin Pages (Developer Dashboard - SaaS Owner)
...
import BillingManagement from "./pages/platform/BillingManagement";
import ErrorLogs from "./pages/platform/ErrorLogs";
...
import DatabaseManagement from "./pages/platform/DatabaseManagement";
import ApiKeysManagement from "./pages/platform/ApiKeysManagement";
...
import CompanyOnboarding from "./pages/platform/CompanyOnboarding";
import SetupAccount from "./pages/auth/SetupAccount";
import ExternalLogin from "./pages/auth/ExternalLogin";
import AuthCallback from "./pages/auth/AuthCallback";
// White-label Tenant Booking
import TenantBooking from "./pages/book/TenantBooking";
      ...
      <AuthProvider>
        <CurrencyProvider>
          ...
          <Router>
            ...
            <Route path="/connect" element={<SaasLogin />} />
            ...
            {/* Platform Admin Routes (Developer Dashboard - SaaS Owner) */}
            <Route path="/platform/login" element={<PlatformLogin />} />
            <Route path="/platform" element={<PlatformDashboard />} />
            <Route path="/platform/tenants" element={<TenantManagement />} />
            <Route path="/platform/onboarding" element={<CompanyOnboarding />} />
            <Route path="/platform/monitoring" element={<SystemMonitoring />} />
            <Route path="/platform/billing" element={<BillingManagement />} />
            <Route path="/platform/logs" element={<ErrorLogs />} />
            <Route path="/platform/settings" element={<GlobalSettings />} />
            <Route path="/platform/announcements" element={<Announcements />} />
            <Route path="/platform/users" element={<UsersManagement />} />
            <Route path="/platform/analytics" element={<Analytics />} />
            <Route path="/platform/database" element={<DatabaseManagement />} />
            <Route path="/platform/api-keys" element={<ApiKeysManagement />} />
            <Route path="/platform/integrations" element={<Integrations />} />
            <Route path="/platform/features" element={<FeatureFlags />} />
            <Route path="/platform/templates" element={<Templates />} />
            <Route path="/platform/plans" element={<SubscriptionPlans />} />
            
            {/* White-label Tenant Booking Routes */}
            <Route path="/book/:slug" element={<TenantBooking />} />
            <Route path="/book/:slug/checkout" element={<TenantBooking />} />
