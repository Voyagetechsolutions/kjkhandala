...
export default function FinanceLayout({ children }: FinanceLayoutProps) {
  ...
  const navItems = [
    ...
    { path: "/finance/revenue", icon: BarChart3, label: "Revenue Analysis" },
    { path: "/finance/payroll", icon: Users, label: "Payroll Management" },
    { path: "/finance/fuel", icon: Fuel, label: "Fuel & Allowances" },
    ...
    { path: "/finance/reconciliation", icon: Landmark, label: "Accounts & Reconciliation" },
