  ...
  const menuStructure = {
    operations: {
      ...
      items: [
        ...
        { path: "/admin/trips", icon: Calendar, label: "Trip Management" },
        { path: "/admin/assign-bus", icon: Bus, label: "Assign Bus" },
        { path: "/admin/shifts", icon: UserCog, label: "Driver Shifts" },
        ...
        { path: "/admin/manifest", icon: ClipboardList, label: "Passenger Manifest" },
        { path: "/admin/reports", icon: BarChart3, label: "Reports and Analytics" },
        { path: "/admin/terminal-operations", icon: Building2, label: "Terminal Operations" },
        { path: "/admin/terminals", icon: Building2, label: "Terminal Management" },
      ]
    },
    finance: {
      ...
      items: [
        ...
        { path: "/admin/finance/revenue", icon: PieChart, label: "Revenue Analysis" },
        { path: "/admin/finance/payroll", icon: Wallet, label: "Payroll Management" },
        { path: "/admin/finance/fuel", icon: Fuel, label: "Fuel and Allowance" },
        ...
        { path: "/admin/finance/reconciliation", icon: Calculator, label: "Accounts and Reconciliation" },
      ]
    },
    ticketing: {
      label: "Ticketing",
      ...
      items: [
        ...
        { path: "/admin/ticketing/search", icon: Search, label: "Search Trips" },
        { path: "/admin/ticketing/reserved", icon: Clock, label: "Reserved Seats" },
        { path: "/admin/ticketing/modify", icon: RefreshCw, label: "Modify Booking" },
        { path: "/admin/ticketing/refund", icon: AlertTriangle, label: "Cancel & Refund" },
        { path: "/admin/ticketing/customers", icon: Users, label: "Customer Lookup" },
    ...
    hr: {
      ...
      items: [
        ...
        { path: "/admin/support", icon: Headphones, label: "Customer Support" },
