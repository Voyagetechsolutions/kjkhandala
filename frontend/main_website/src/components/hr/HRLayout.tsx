...
export default function HRLayout({ children }: HRLayoutProps) {
  ...
  const navItems = [
    ...
    { path: "/hr/recruitment", icon: UserPlus, label: "Recruitment" },
    { path: "/hr/attendance", icon: Clock, label: "Attendance" },
    { path: "/hr/payroll", icon: DollarSign, label: "Payroll" },
    { path: "/hr/performance", icon: Award, label: "Performance" },
    { path: "/hr/compliance", icon: FileCheck, label: "Compliance" },
    { path: "/hr/leave", icon: Calendar, label: "Leave" },
    { path: "/hr/documents", icon: FileText, label: "Documents" },
