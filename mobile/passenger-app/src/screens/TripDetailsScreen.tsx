  ...
  if (!tripId) {
    return (
      <View style={styles.centered}>
        <Text style={styles.errorText}>Trip not specified</Text>
      </View>
    );
  }
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.time}>
          {trip.scheduled_departure ? format(new Date(trip.scheduled_departure), 'MMM dd, yyyy • HH:mm') : 'N/A'}
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  route: { fontSize: 24, fontWeight: '700', color: '#fff' },
  distance: { fontSize: 14, color: '#fff', marginTop: 4 },
  ...
  price: { fontSize: 28, fontWeight: '700', color: '#2563eb' },
