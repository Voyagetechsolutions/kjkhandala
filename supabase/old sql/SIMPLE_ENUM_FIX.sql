-- =====================================================
-- SIMPLE ENUM FIX - No Views, No Window Functions
-- =====================================================

-- 1. Drop dependent views
DROP VIEW IF EXISTS bus_utilization CASCADE;

-- 2. Drop old enums (will cascade to columns)
...
-- 4. Add status columns with enum type
ALTER TABLE buses ADD COLUMN IF NOT EXISTS status bus_status DEFAULT 'active';
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS status driver_status DEFAULT 'active';

-- =====================================================
-- 5. ADD ALL MISSING COLUMNS
-- =====================================================
...
-- ROUTES
ALTER TABLE routes 
ADD COLUMN IF NOT EXISTS route_code TEXT UNIQUE,
...
-- Create new policies
CREATE POLICY "Allow all for authenticated users" ON buses FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON drivers FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON routes FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON trips FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON bookings FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON profiles FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON income FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON maintenance_alerts FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users" ON user_roles FOR ALL USING (true) WITH CHECK (true);
