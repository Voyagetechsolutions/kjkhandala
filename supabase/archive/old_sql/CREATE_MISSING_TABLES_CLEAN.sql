-- =====================================================
-- CREATE MISSING TABLES (CLEAN VERSION)
-- Run this FIRST before dashboard views
-- =====================================================

-- =====================================================
-- 1. MAINTENANCE_REMINDERS TABLE
-- =====================================================
...
CREATE INDEX IF NOT EXISTS maintenance_reminders_completed_idx ON maintenance_reminders(completed_at);

-- =====================================================
-- 2. GPS_TRACKING TABLE
-- =====================================================
...
-- =====================================================
-- 7. CREATE RLS POLICIES (Simple - Allow All)
-- =====================================================

DROP POLICY IF EXISTS "Allow all" ON maintenance_reminders;
CREATE POLICY "Allow all" ON maintenance_reminders FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all" ON gps_tracking;
CREATE POLICY "Allow all" ON gps_tracking FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all" ON maintenance_records;
CREATE POLICY "Allow all" ON maintenance_records FOR ALL USING (true) WITH CHECK (true);
