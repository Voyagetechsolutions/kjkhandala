-- ============================================================================
-- MIGRATION: Automated Shifts and Status Updates
-- ============================================================================

-- Step 1: Add trip_id to driver_shifts if it doesn't exist
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- Step 3: Ensure is_generated_from_schedule exists on trips
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
...
-- Step 4: Create/Update function to generate scheduled trips with automatic shift creation
...
-- Step 5: Create function to auto-update trip statuses
...
-- Step 6: Create function to auto-update driver shift statuses
